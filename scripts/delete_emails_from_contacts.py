...
parser = argparse.ArgumentParser(
    description='Remove email addresses from contacts in CSV file'
)
...
if any(
    field not in reader.fieldnames for field in ['contact_id', 'email_address']
):
    print(
        'contact_id or email_address headers could not be found in your csv file.'
    )
    sys.exit(-1)
