...
parser.add_argument('--activity-type', '-t', choices=['call', 'created', 'email', 'lead_status_change', 'note', 'opportunity_status_change', 'sms', 'task_completed'], required=True,
...
def getActivities(day):
	print("Getting all %s activites for %s..." % (args.activity_type, day['day']))
	has_more = True
	offset = 0
	while has_more:
